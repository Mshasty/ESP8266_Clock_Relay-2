...
void interface(){ // функция в которой мы формируем веб интерфейс и интерфейс в приложении JeeUI2
  ...
  jee.checkbox("ch1_on", "Первый канал"); // Это переключатель, чтобы щелкать релющкой вручную
  jee.checkbox("ch2_on", "Второй канал"); // Это переключатель, чтобы щелкать релющкой вручную
